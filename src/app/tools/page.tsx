    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-[var(--muted)] max-w-2xl mx-auto">
          {FREE_TOOL_COUNT} core tools have free access. {PREMIUM_TOOL_COUNT} professional Premium tools add automation, bulk workflows, and AI—with free previews where shown.
        </p>
      </div>
