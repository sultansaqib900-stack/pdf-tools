      ...
      <div className="bg-[var(--card)] rounded-xl border border-[var(--card-border)] p-8">
        ...
        >
          ...
          <label htmlFor="fileInput" className="cursor-pointer flex flex-col items-center gap-3">
            ...
            <span className="text-indigo-500 font-medium hover:underline">Haz clic para seleccionar o arrastra PDFs</span>
            ...
            {files.map((file, i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-[var(--background)] border border-[var(--card-border)] rounded-lg">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button onClick={() => removeFile(i)} className="p-1 text-red-500 hover:text-red-600" title="Eliminar">
        ...
        {files.length > 0 && files.length < 2 && (
          <p className="text-xs text-amber-500 mt-2 text-center">Selecciona al menos 2 archivos PDF para unir.</p>
        )}
