  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-[var(--muted)] space-y-4 leading-relaxed">
        ...
        <p>Using <Link href="/merge" className="text-[var(--accent)] hover:underline">PDFTools Merge PDF</Link> tool:</p>
        <ol className="list-decimal list-inside space-y-2">
          <li>Go to the <Link href="/merge" className="text-[var(--accent)] hover:underline">Merge PDF page</Link></li>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>Compress after merging</strong> &mdash; If the merged file is large, use the <Link href="/compress" className="text-[var(--accent)] hover:underline">Compress PDF</Link> tool afterward</li>
          <li><strong>Add page numbers</strong> &mdash; After merging, use the <Link href="/add-page-numbers" className="text-[var(--accent)] hover:underline">Add Page Numbers</Link> tool to number your document</li>
        </ul>
        ...
        <p>The free version supports files up to 10MB each and merging up to 20 files at once. For larger files or batch processing, <Link href="/premium" className="text-[var(--accent)] hover:underline">upgrade to Premium</Link> for 100MB file support and no wait times.</p>

        <p className="pt-4">Ready to merge? Try the <Link href="/merge" className="text-[var(--accent)] font-medium hover:underline">free online PDF merger</Link> now.</p>

        <p className="pt-4">After merging, you might also want to <Link href="/blog/organize-pdf-pages" className="text-[var(--accent)] font-medium hover:underline">reorder and organize pages</Link> or <Link href="/blog/compress-pdf-without-losing-quality" className="text-[var(--accent)] font-medium hover:underline">compress the final document</Link> for easier sharing.</p>
      </div>
    </article>
  );
}
