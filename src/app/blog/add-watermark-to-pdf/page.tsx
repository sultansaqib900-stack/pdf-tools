  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Watermarks are essential for protecting your intellectual property, marking documents as drafts, or branding PDFs with your company name. Our <a href="/watermark" className="text-[var(--accent)] underline">free PDF watermark tool</a> lets you add text or image watermarks to every page of your PDF instantly in your browser.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the watermark tool</strong> — Go to our <a href="/watermark" className="text-[var(--accent)] underline">PDF Watermark tool</a>.</li>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/watermark" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Add Watermark Now →</a>
        </div>
      </div>
    </article>
  );
