  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Converting images to PDF is one of the most common PDF tasks. Whether you are combining scanned photos into a digital album, sending a batch of receipts to your accountant, or creating a portfolio from separate images, our <a href="/image-to-pdf" className="text-[var(--accent)] underline">free image to PDF converter</a> makes it effortless.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the converter</strong> — Go to our <a href="/image-to-pdf" className="text-[var(--accent)] underline">Image to PDF tool</a>.</li>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/image-to-pdf" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Convert Now →</a>
        </div>
      </div>
    </article>
  );
