  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Protecting sensitive PDF documents with a password is essential for maintaining confidentiality. Whether you are sharing financial reports, legal contracts, medical records, or personal documents, adding password encryption ensures only authorized recipients can open them. Our <a href="/protect" className="text-[var(--accent)] underline">free PDF password protector</a> applies encryption directly in your browser.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the protector</strong> — Go to our <a href="/protect" className="text-[var(--accent)] underline">Password Protect tool</a>.</li>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>Avoid common words, names, dates, or <code className="text-[var(--foreground)] bg-[var(--surface)] px-1 rounded">password123</code></li>
        ...
        <p>If you need to remove password protection from a PDF, use our <a href="/unlock" className="text-[var(--accent)] underline">Unlock PDF tool</a>. All encryption and decryption happens locally — your files never leave your device and no passwords are transmitted anywhere.</p>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/protect" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Protect PDF Now →</a>
        </div>
      </div>
    </article>
  );
