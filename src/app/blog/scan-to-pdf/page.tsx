  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Turn your device into a portable document scanner with our <a href="/scan-to-pdf" className="text-[var(--accent)] underline">free online Scan to PDF tool</a>. Capture receipts, contracts, handwritten notes, or whiteboard sketches and convert them instantly to PDF — all within your browser with zero uploads.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the camera</strong> — Go to our <a href="/scan-to-pdf" className="text-[var(--accent)] underline">Scan to PDF tool</a> and click Open Camera.</li>
