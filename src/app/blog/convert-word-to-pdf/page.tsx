  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Converting Word documents to PDF ensures your formatting stays intact across any device or platform. Our <a href="/word-to-pdf" className="text-[var(--accent)] underline">free online Word to PDF converter</a> turns your DOCX files into professional PDFs — all in your browser.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Upload DOCX</strong> — Go to our <a href="/word-to-pdf" className="text-[var(--accent)] underline">Word to PDF tool</a> and select your Word document.</li>
