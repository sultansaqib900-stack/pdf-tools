  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-[var(--muted)] space-y-4 leading-relaxed">
        ...
        <p>Using <Link href="/crop" className="text-[var(--accent)] hover:underline">PDFTools Crop PDF</Link> tool:</p>
        <ol className="list-decimal list-inside space-y-2">
          <li>Go to the <Link href="/crop" className="text-[var(--accent)] hover:underline">Crop PDF page</Link></li>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>Use the <Link href="/resize" className="text-[var(--accent)] hover:underline">Resize PDF</Link> tool if you need to change the overall page size</li>
          <li>Different pages may need different crop amounts — try the <Link href="/split" className="text-[var(--accent)] hover:underline">Split PDF</Link> tool first if needed</li>
        </ul>

        <p className="pt-4">Try the <Link href="/crop" className="text-[var(--accent)] font-medium hover:underline">free online PDF cropper</Link> now.</p>

        <p className="pt-4">Need to change the overall page size instead? Read our guide on <Link href="/blog/resize-pdf-pages" className="text-[var(--accent)] font-medium hover:underline">how to resize PDF pages</Link> for A4, Letter, and custom sizes.</p>
      </div>
    </article>
  );
}
