      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4 mb-6">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/batch" className="text-[var(--accent)] hover:underline">Batch Process PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/bulk-rename" className="text-[var(--accent)] hover:underline">Bulk Rename PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/merge" className="text-[var(--accent)] hover:underline">Merge Multiple PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/certificate-generator" className="text-[var(--accent)] hover:underline">Bulk Certificate Generator</Link></h3>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-5 mb-6">
        ...
        <div className="bg-[var(--accent)] rounded-[var(--r-lg)] p-6 text-white text-center">
          ...
          <Link href="/batch" className="inline-block px-6 py-3 bg-white text-[var(--accent)] font-medium rounded-[var(--r-lg)] hover:bg-white/90 transition">Try Batch Processing →</Link>
        </div>
      </div>
    </>
  );
