    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><strong>Batch compress</strong> — Reduce file size for multiple PDFs before emailing or uploading</li>
          <li><strong>Batch merge</strong> — Combine several sets of PDFs into single documents</li>
          <li><strong>Batch convert</strong> — Turn multiple PDFs into images or extract text from each</li>
          <li><strong>Batch protect</strong> — Apply the same password to a whole folder of PDFs</li>
        </ul>
