  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>PDF/A is the ISO-standardized version of PDF designed for long-term archiving. Our <a href="/pdf-to-pdfa" className="text-[var(--accent)] underline">free online PDF to PDF/A converter</a> transforms your PDFs into this preservation-friendly format.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Upload PDF</strong> — Go to our <a href="/pdf-to-pdfa" className="text-[var(--accent)] underline">PDF to PDF/A tool</a> and select your file.</li>
