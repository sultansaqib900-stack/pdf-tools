  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Imagine being able to ask questions about any PDF document and get instant answers — without reading through hundreds of pages. That&apos;s exactly what our <a href="/chat-pdf" className="text-[var(--accent)] underline">free Chat with PDF tool</a> does. Upload a research paper, contract, book, or report, and start asking questions. The AI reads the document and answers based only on what&apos;s in the file.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Upload your PDF</strong> — Go to our <a href="/chat-pdf" className="text-[var(--accent)] underline">Chat with PDF tool</a> and select your file (up to 20MB).</li>
        ...
        <p>Free users get 3 questions per day to try the feature. <a href="/premium" className="text-[var(--accent)] underline">Premium subscribers</a> get unlimited questions, larger file support, and priority processing — perfect for professionals who work with documents daily.</p>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/chat-pdf" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Chat with Your PDF Now →</a>
        </div>
      </div>
    </article>
  );
