  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Converting HTML to PDF is a common need for developers, designers, and business professionals. Whether you need to save a web page for offline reading, generate invoices from HTML templates, or create printable documentation from web content, our <a href="/html-to-pdf" className="text-[var(--accent)] underline">free HTML to PDF converter</a> handles it instantly.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the converter</strong> — Go to our <a href="/html-to-pdf" className="text-[var(--accent)] underline">HTML to PDF tool</a>.</li>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/html-to-pdf" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Convert Now →</a>
        </div>
      </div>
    </article>
  );
