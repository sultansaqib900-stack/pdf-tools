  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-sm text-[var(--muted)] mb-4">Merging PDFs combines multiple documents into one organized file. Whether you&apos;re combining invoices, merging scanned pages, or compiling a report, <Link href="/merge" className="text-[var(--accent)] underline">PDFTools Merge</Link> makes it simple.</p>
        ...
        <ol className="list-decimal pl-5 text-sm text-[var(--muted)] space-y-2 mb-6">
          <li>Go to <Link href="/merge" className="text-[var(--accent)] underline">PDFTools Merge</Link></li>
        ...
        <div className="bg-[var(--accent-subtle)] border border-[var(--accent-border)] rounded-[var(--r-lg)] p-5 mb-6">
          <p className="text-sm text-[var(--muted)]"><strong>Pro tip:</strong> Use <Link href="/organize" className="text-[var(--accent)] underline">Organize Pages</Link> after merging to reorder, rotate, or delete specific pages.</p>
        </div>
        ...
        <div className="bg-[var(--accent)] rounded-[var(--r-lg)] p-6 text-white text-center">
          ...
          <Link href="/merge" className="inline-block px-6 py-3 bg-white text-[var(--accent)] font-medium rounded-[var(--r-lg)] hover:bg-white/90 transition">Merge PDFs Now →</Link>
        </div>
      </div>
    </>
  );
