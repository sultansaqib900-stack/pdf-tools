    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <ol className="list-decimal pl-5 text-sm text-[var(--muted)] space-y-2 mb-6">
          ...
          <li>Visit <Link href="/" className="text-[var(--accent)] underline">PDFTools</Link> and choose your tool (compress, merge, split, etc.)</li>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-6">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/compress" className="text-[var(--accent)] hover:underline">Compress PDF</Link></h3>
            <p className="text-xs text-[var(--muted)]">Reduce file size before sharing via Google Drive link. Smaller files load faster.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/merge" className="text-[var(--accent)] hover:underline">Merge PDFs</Link></h3>
            <p className="text-xs text-[var(--muted)]">Combine multiple PDFs from Drive into one document for easier management.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/image-to-pdf" className="text-[var(--accent)] hover:underline">Image to PDF</Link></h3>
            <p className="text-xs text-[var(--muted)]">Convert scanned images stored in Drive to PDF documents.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)]"><Link href="/protect" className="text-[var(--accent)] hover:underline">Protect PDF</Link></h3>
            <p className="text-xs text-[var(--muted)]">Add password protection to sensitive Drive PDFs before sharing.</p>
          </div>
        </div>

        <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-[var(--r-lg)] p-5 mb-6">
        ...
        <div className="bg-[var(--accent)] rounded-[var(--r-lg)] p-6 text-white text-center">
          ...
          <Link href="/" className="inline-block px-6 py-3 bg-white text-[var(--accent)] font-medium rounded-[var(--r-lg)] hover:bg-white/90 transition">Browse PDF Tools →</Link>
        </div>
      </div>
    </>
  );
