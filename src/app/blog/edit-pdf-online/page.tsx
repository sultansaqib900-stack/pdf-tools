  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Editing PDFs usually requires expensive software like Adobe Acrobat. Our <a href="/edit-pdf" className="text-[var(--accent)] underline">free online PDF editor</a> lets you add text boxes, draw shapes, and annotate any PDF directly in your browser — no installation, no uploads, no fees.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Upload</strong> — Go to our <a href="/edit-pdf" className="text-[var(--accent)] underline">Edit PDF tool</a> and select your file.</li>
