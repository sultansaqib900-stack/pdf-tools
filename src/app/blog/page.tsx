...
export default function BlogPage() {
  const posts = [
    ...
    },
    {
      ...
      excerpt: "Learn how to merge PDF files online free. Combine multiple PDFs into one document in seconds.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
      ...
      excerpt: "Learn how to convert images to PDF online free. Convert JPG, PNG, WebP images to PDF documents.",
      date: "June 27, 2026",
      readTime: "3 min read",
    },
    {
      slug: "ai-pdf-summarization",
      title: "How to Summarize PDFs with AI — Free Online PDF Summary Tool",
      excerpt: "Learn how to use AI to summarize PDF documents online free. Extract key points, generate summaries, and save hours of reading time.",
      date: "June 27, 2026",
      readTime: "5 min read",
    },
    {
      slug: "google-drive-pdf-editor",
      title: "How to Edit PDFs from Google Drive — Free Online PDF Editor",
      excerpt: "Edit PDFs stored in Google Drive directly from your browser. No downloads, no uploads to third-party servers.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
      slug: "automate-pdf-workflow",
      title: "How to Automate PDF Workflows — Batch Processing & Automation",
      excerpt: "Learn how to automate PDF processing workflows. Batch compress, watermark, merge, and rename PDFs automatically.",
      date: "June 27, 2026",
      readTime: "6 min read",
    },
    {
      ...
      excerpt: "Scan documents to PDF using your device camera. Capture receipts, contracts, and notes and convert them instantly to PDF.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
      ...
      excerpt: "Extract text from scanned PDFs and images using free online OCR. Make scanned documents searchable and editable.",
      date: "June 27, 2026",
      readTime: "5 min read",
    },
    {
      ...
      excerpt: "Edit PDF files online for free. Add text boxes, rectangles, circles, and lines to any PDF without installing software.",
      date: "June 27, 2026",
      readTime: "5 min read",
    },
    {
      ...
      excerpt: "Convert PDF to editable Word DOCX files online free. Extract text from PDF documents and download as Microsoft Word format.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
      ...
      excerpt: "Convert Word DOCX documents to PDF online free. Turn your Word files into professional PDFs instantly.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
      ...
      excerpt: "Fix corrupted or damaged PDF files online free. Rebuild PDF structure and recover your documents.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
      slug: "convert-pdf-to-pdfa",
      title: "Convert PDF to PDF/A Online Free — Archive Format Converter",
      excerpt: "Convert PDF to PDF/A archive format for long-term preservation. Ensure your documents remain readable for decades.",
      date: "June 27, 2026",
      readTime: "4 min read",
    },
    {
