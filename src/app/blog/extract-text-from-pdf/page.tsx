    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the extractor</strong> — Visit our <a href="/extract-text" className="text-[var(--accent)] underline">PDF text extractor tool</a>.</li>
        ...
        <p>Text extraction works best on digital PDFs where text is already selectable. For scanned documents or image-based PDFs, the text is part of an image and cannot be extracted as editable text without OCR (optical character recognition). If your PDF is a scan, consider using our <a href="/image-to-pdf" className="text-[var(--accent)] underline">image tools</a> to convert it first, or use a dedicated OCR service for scanned documents.</p>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/extract-text" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Extract Text Now →</a>
        </div>
      </div>
    </article>
  );
