  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Need to extract certain pages from a large PDF or split a document into individual pages? Our free <a href="/split" className="text-[var(--accent)] underline">Split PDF tool</a> lets you do exactly that — all in your browser, no uploads, no signup.</p>
        ...
        <p>Use our <a href="/split" className="text-[var(--accent)] underline">Split PDF tool</a> when you need multiple separate files from one document. Use <a href="/delete-pages" className="text-[var(--accent)] underline">Delete Pages</a> when you want to remove pages and keep the rest as one PDF.</p>
        ...
        <p>Free users can split PDFs up to 10MB. <a href="/premium" className="text-[var(--accent)] underline">Premium subscribers</a> get up to 100MB file support and batch processing capabilities.</p>
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li><a href="/merge" className="text-[var(--accent)] underline">Merge PDF</a> — Combine multiple PDFs into one document</li>
          <li><a href="/delete-pages" className="text-[var(--accent)] underline">Delete Pages</a> — Remove unwanted pages from a PDF</li>
          <li><a href="/organize" className="text-[var(--accent)] underline">Organize Pages</a> — Reorder pages by drag and drop</li>
          <li><a href="/split" className="text-[var(--accent)] underline">Split PDF</a> — Extract pages or split into separate files</li>
        </ul>
      </div>
    </article>
  );
