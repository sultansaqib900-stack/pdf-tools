    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <ol className="list-decimal pl-5 text-sm text-[var(--muted)] space-y-2 mb-6">
          <li>Visit <Link href="/chat-pdf" className="text-[var(--accent)] underline">PDFTools Chat with PDF</Link></li>
        ...
        <div className="bg-[var(--accent)] rounded-[var(--r-lg)] p-6 text-white text-center">
          ...
          <Link href="/chat-pdf" className="inline-block px-6 py-3 bg-white text-[var(--accent)] font-medium rounded-[var(--r-lg)] hover:bg-white/90 transition">Chat with Your PDF →</Link>
        </div>
      </div>
    </>
  );
