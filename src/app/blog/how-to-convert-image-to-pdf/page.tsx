  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-sm text-[var(--muted)] mb-4">Converting images to PDF is essential for creating documents from photos, scans, and screenshots. <Link href="/image-to-pdf" className="text-[var(--accent)] underline">PDFTools Image to PDF</Link> lets you convert JPG, PNG, and WebP images into a professional PDF document in seconds.</p>
        ...
        <ol className="list-decimal pl-5 text-sm text-[var(--muted)] space-y-2 mb-6">
          <li>Go to <Link href="/image-to-pdf" className="text-[var(--accent)] underline">PDFTools Image to PDF</Link></li>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4 text-center">
        ...
        <div className="bg-[var(--accent)] rounded-[var(--r-lg)] p-6 text-white text-center">
          ...
          <Link href="/image-to-pdf" className="inline-block px-6 py-3 bg-white text-[var(--accent)] font-medium rounded-[var(--r-lg)] hover:bg-white/90 transition">Convert Now →</Link>
        </div>
      </div>
    </>
  );
