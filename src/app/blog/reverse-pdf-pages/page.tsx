  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Have a scanned document that reads backwards? Or a presentation where the slides are in reverse order? Our <a href="/reverse-pdf" className="text-[var(--accent)] underline">free PDF reverser tool</a> lets you <strong>reverse PDF page order</strong> instantly — the last page becomes first, second-last becomes second, and so on. All in your browser with no uploads.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Go to the reverser</strong> — Open our <a href="/reverse-pdf" className="text-[var(--accent)] underline">free PDF page reverser</a>.</li>
        ...
        <p>If you need more control than a simple reverse — like moving specific pages or rearranging individual pages — use our <a href="/organize" className="text-[var(--accent)] underline">drag-and-drop page organizer</a>. It lets you reorder pages one by one with a visual interface. Combined with <a href="/reverse-pdf" className="text-[var(--accent)] underline">reverse</a>, you can fix any page ordering issue.</p>

        <h2 className="text-xl font-bold text([--foreground]) pt-4">What About Large PDFs?</h2>
        <p>Free users can reverse PDFs up to 10MB. <a href="/premium" className="text-[var(--accent)] underline">Premium users</a> get a 100MB limit with no wait times, making it easy to reverse large scanned documents or lengthy reports.</p>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/reverse-pdf" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Reverse Your PDF Now →</a>
        </div>
      </div>
    </article>
  );
