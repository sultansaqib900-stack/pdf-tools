  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>A corrupted PDF can be frustrating — especially when it contains important information. Our <a href="/repair-pdf" className="text-[var(--accent)] underline">free online PDF repair tool</a> rebuilds damaged PDF files, recovering your content whenever possible.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Upload</strong> — Go to our <a href="/repair-pdf" className="text-[var(--accent)] underline">Repair PDF tool</a> and select the corrupted file.</li>
