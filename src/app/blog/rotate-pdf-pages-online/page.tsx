    ...
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Open the rotator</strong> — Go to our <a href="/rotate" className="text-[var(--accent)] underline">PDF rotate tool</a>.</li>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6 mt-6">
          ...
          <a href="/rotate" className="inline-block px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Rotate PDF Now →</a>
        </div>
      </div>
    </article>
  );
