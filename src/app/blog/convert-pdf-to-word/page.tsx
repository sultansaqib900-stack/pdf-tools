  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-sm text-[var(--muted)] space-y-5 leading-relaxed">
        <p>Need to edit a PDF but only have a Word processor? Our <a href="/pdf-to-word" className="text-[var(--accent)] underline">free online PDF to Word converter</a> extracts text from PDF documents and creates editable DOCX files — all in your browser with zero uploads.</p>
        ...
        <ol className="list-decimal pl-5 space-y-3">
          <li><strong>Upload PDF</strong> — Go to our <a href="/pdf-to-word" className="text-[var(--accent)] underline">PDF to Word tool</a> and select your file.</li>
