...
export default function UltimateGuidePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <nav className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-5 mb-10">
        <h2 className="font-semibold text-[var(--foreground)] mb-3">Table of Contents</h2>
        <ul className="space-y-1.5 text-sm">
          <li><a href="#what-is-pdf" className="text-[var(--accent)] hover:underline">1. What is a PDF?</a></li>
          <li><a href="#basic-editing" className="text-[var(--accent)] hover:underline">2. Basic PDF Editing</a></li>
          <li><a href="#compress" className="text-[var(--accent)] hover:underline">3. Compressing PDFs</a></li>
          <li><a href="#merge-split" className="text-[var(--accent)] hover:underline">4. Merging &amp; Splitting PDFs</a></li>
          <li><a href="#convert" className="text-[var(--accent)] hover:underline">5. Converting PDFs</a></li>
          <li><a href="#security" className="text-[var(--accent)] hover:underline">6. PDF Security</a></li>
          <li><a href="#annotate" className="text-[var(--accent)] hover:underline">7. Annotating &amp; Signing</a></li>
          <li><a href="#advanced" className="text-[var(--accent)] hover:underline">8. Advanced Features</a></li>
          <li><a href="#ai" className="text-[var(--accent)] hover:underline">9. AI-Powered PDF Tools</a></li>
          <li><a href="#tips" className="text-[var(--accent)] hover:underline">10. Tips &amp; Best Practices</a></li>
        </ul>
      </nav>
      ...
      <section id="basic-editing" className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/rotate" className="text-[var(--accent)] hover:underline">Rotate PDF Pages</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/organize" className="text-[var(--accent)] hover:underline">Organize PDF Pages</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/delete-pages" className="text-[var(--accent)] hover:underline">Delete PDF Pages</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/edit-pdf" className="text-[var(--accent)] hover:underline">Edit PDF Content</Link></h3>
      ...
      <section id="compress" className="mb-10">
        ...
        <p className="text-sm text-[var(--muted)] mb-3">Our <Link href="/compress" className="text-[var(--accent)] underline">PDF Compressor</Link> uses pdf-lib to compress PDFs client-side. You can choose from multiple compression levels:</p>
      ...
      <section id="merge-split" className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/merge" className="text-[var(--accent)] hover:underline">Merge PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/split" className="text-[var(--accent)] hover:underline">Split PDF</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/split-by-bookmarks" className="text-[var(--accent)] hover:underline">Split by Bookmarks</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/insert-blank" className="text-[var(--accent)] hover:underline">Insert Blank Pages</Link></h3>
      ...
      <section id="convert" className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/image-to-pdf" className="text-[var(--accent)] hover:underline">Image to PDF</Link></h3>
            <p className="text-xs text-[var(--muted)]">Convert JPG, PNG, WebP images to PDF. Combines multiple images into one PDF document.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-to-images" className="text-[var(--accent)] hover:underline">PDF to Images</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/html-to-pdf" className="text-[var(--accent)] hover:underline">HTML to PDF</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/text-to-pdf" className="text-[var(--accent)] hover:underline">Text to PDF</Link></h3>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-to-word" className="text-[var(--accent)] hover:underline">PDF to Word</Link></h3>
            <p className="text-xs text-[var(--muted)]">Extract text from PDFs and convert to editable DOCX format for Microsoft Word.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/word-to-pdf" className="text-[var(--accent)] hover:underline">Word to PDF</Link></h3>
            <p className="text-xs text-[var(--muted)]">Convert Word documents to PDF while preserving formatting and layout.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-to-excel" className="text-[var(--accent)] hover:underline">PDF to Excel</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-to-pdfa" className="text-[var(--accent)] hover:underline">PDF to PDF/A</Link></h3>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-to-audio" className="text-[var(--accent)] hover:underline">PDF to Audio</Link></h3>
            <p className="text-xs text-[var(--muted)]">Listen to your PDFs. Converts text to speech with voice selection and speed control.</p>
          </div>
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/scan-to-pdf" className="text-[var(--accent)] hover:underline">Scan to PDF</Link></h3>
      ...
      <section id="security" className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/protect" className="text-[var(--accent)] hover:underline">Protect PDF with Password</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/unlock" className="text-[var(--accent)] hover:underline">Unlock PDF</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/redact" className="text-[var(--accent)] hover:underline">Redact PDF</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/search-redact" className="text-[var(--accent)] hover:underline">Search &amp; Redact</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/metadata-sanitizer" className="text-[var(--accent)] hover:underline">Clean PDF Metadata</Link></h3>
      ...
      <section id="annotate" className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/annotate" className="text-[var(--accent)] hover:underline">Annotate PDF</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/sign" className="text-[var(--accent)] hover:underline">Sign PDF</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/fill-form" className="text-[var(--accent)] hover:underline">Fill PDF Forms</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/watermark" className="text-[var(--accent)] hover:underline">Add Watermark</Link></h3>
      ...
      <section id="advanced" className="mb-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/batch" className="text-[var(--accent)] hover:underline">Batch Process PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-diff" className="text-[var(--accent)] hover:underline">Compare PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/certificate-generator" className="text-[var(--accent)] hover:underline">Certificate Generator</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/bates-numbering" className="text-[var(--accent)] hover:underline">Bates Numbering</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/booklet" className="text-[var(--accent)] hover:underline">PDF Booklet</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/bulk-rename" className="text-[var(--accent)] hover:underline">Bulk Rename PDFs</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/pdf-inverter" className="text-[var(--accent)] hover:underline">PDF Dark Mode</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-4">
            <h3 className="font-semibold text-[var(--foreground)] mb-1"><Link href="/qr-stamp" className="text-[var(--accent)] hover:underline">QR Code Stamping</Link></h3>
      ...
      <section id="ai" className="mb-10">
        ...
        <div className="space-y-4 mb-4">
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-5">
            <h3 className="font-semibold mb-1 text-[var(--foreground)]"><Link href="/chat-pdf" className="text-[var(--accent)] hover:underline">Chat with PDF (AI)</Link></h3>
          ...
          <div className="border border-[var(--border)] rounded-[var(--r-lg)] p-5">
            <h3 className="font-semibold mb-1 text-[var(--foreground)]"><Link href="/ocr-pdf" className="text-[var(--accent)] hover:underline">OCR PDF (Text Recognition)</Link></h3>
        ...
        <div className="bg-[var(--accent-subtle)] border border-[var(--accent-border)] rounded-[var(--r-lg)] p-5">
      ...
      <div className="bg-[var(--accent-subtle)] border-2 border-[var(--accent-border)] rounded-[var(--r-lg)] p-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link href="/compress" className="px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent-hover)] transition">Compress PDF</Link>
          <Link href="/merge" className="px-5 py-2.5 bg-[var(--success)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:opacity-90 transition">Merge PDF</Link>
          <Link href="/split" className="px-5 py-2.5 bg-[var(--accent)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:bg-[var(--accent)] transition">Split PDF</Link>
          <Link href="/image-to-pdf" className="px-5 py-2.5 bg-[var(--premium)] text-white font-medium rounded-[var(--r-lg)] text-sm hover:opacity-90 transition">Image to PDF</Link>
        </div>
      </div>
    </div>
  );
