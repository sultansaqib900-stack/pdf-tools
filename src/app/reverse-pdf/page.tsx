...
export default function ReversePDFPage() {
  ...
  return (
    <ToolShell icon="reverse" title={"Reverse PDF Order"} lead={"Flip the page order of any PDF file completely."}>
      <SoftwareAppJsonLd
          ...
          <>
            ...
            {!isPremium() && (
              <p className="mt-3 text-center text-xs text-[var(--muted)]">
                ...
                <a href="/premium" className="text-[var(--accent)] font-medium hover:underline">Upgrade for 100MB & no wait</a>
              </p>
            )}
          </>
        )}
