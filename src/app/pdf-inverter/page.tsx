...
export default function PdfInverterPage() {
  const usage = useUsage("pdf-inverter");
  usePageMeta("PDF Color Inverter - Dark Mode & Accessibility Converter | PDFTools", "Convert PDF colors: invert to dark mode, convert to grayscale, or increase contrast for accessibility. Free.");
  ...
  const transform = async () => {
    ...
    try {
      ...
      if (!(await usage.checkAndTrack())) throw new Error("Daily free processing limit reached. Upgrade to Premium for unlimited processing.");
