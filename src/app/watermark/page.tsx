      ...
      <div className="bg-[var(--surface)] rounded-[var(--r-lg)] border border-[var(--border)] p-8">
        ...
        >
          ...
          <label htmlFor="fileInput" className="cursor-pointer flex flex-col items-center gap-3">
            <Icon name="droplet" size={36} className="text-[var(--muted)]" />
          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select value={position} onChange={(e) => setPosition(e.target.value as any)} className="w-full px-3 py-2 rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--background)] text-[var(--foreground)] text-sm outline-none focus:border-[var(--accent-border)] transition">
