...
import { grantConfiguredPremium, isAdminPremiumEmail } from "@/lib/kv";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const premium = (await grantConfiguredPremium(user.id, user.email)) || isAdminPremiumEmail(user.email);
