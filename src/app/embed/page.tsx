    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--r-lg)] p-6">
          ...
          <select
            ...
            className="w-full p-3 rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--background)] text-[var(--foreground)] text-sm"
          >
            {TOOLS.map((t) => (
          ...
          <div className="relative">
            <pre className="p-4 rounded-[var(--r-lg)] bg-gray-900 text-gray-100 text-xs leading-relaxed overflow-x-auto border border-gray-700">
              <code>{snippet}</code>
            </pre>
            <button
              onClick={handleCopy}
              className="absolute top-2 right-2 px-3 py-1.5 bg-[var(--accent)] text-white text-xs font-medium rounded-lg hover:bg-[var(--accent-hover)] transition"
            >
              {copied ? "Copied!" : "Copy"}
            </button>
          </div>
          ...
          <div className="space-y-2 text-sm text-[var(--muted)]">
            <div className="flex gap-2">
              <code className="text-[var(--accent)] font-mono text-xs whitespace-nowrap">theme=&quot;dark&quot;</code>
              <span>Use dark theme</span>
            </div>
            <div className="flex gap-2">
              <code className="text-[var(--accent)] font-mono text-xs whitespace-nowrap">height=&quot;600px&quot;</code>
      ...
      <div className="mt-12 pt-8 border-t border-[var(--border)] space-y-8 text-sm leading-[1.75] text-[var(--muted)]">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--accent)] text-white text-sm font-medium rounded-[var(--r-lg)] hover:bg-[var(--accent-hover)] transition"
        >
