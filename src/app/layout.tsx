...
gtag('config', 'G-0YRS54VR4X');`}
      ...
      <body className="min-h-full flex flex-col">
        ...
        <AnalyticsScript />
        <ClientIdProvider />
        <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[var(--accent)] focus:text-[var(--accent-fg)] focus:rounded-[var(--r-md)] focus:text-sm focus:font-medium">
          Skip to content
        </a>
        <AuthProvider>
